      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-white p-8 md:p-12 rounded-sm shadow-sm border border-[#e0d8c8]">
          ...
          <div className="relative h-[400px] rounded-sm overflow-hidden border border-[#e0d8c8] group">
            <img src="/altres/vistes.webp" alt="Vista panoràmica de Montardit de Dalt al Pallars Sobirà des de Casa Jonico" loading="lazy" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
